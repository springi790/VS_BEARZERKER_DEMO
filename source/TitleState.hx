...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		titleText.frames = Paths.getSparrowAtlas('');
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('moddevs'));
		add(ngSpr);
		ngSpr.visible = false;
		...
		actualNG= new FlxSprite(0, FlxG.height * 0.55).loadGraphic(Paths.image('battlebears.png'));
		...
		switch (curBeat)
		{
			case 5:
						...
						case 12:
							...
							ngSpr.visible = false;
						case 13:
							addMoreText('To the battle');
						case 14:
							addMoreText('Bears');
						case 16:
							addMoreText('Community');
